<section class="web_projects">
    ...
    <div class="u-center-text u-margin-bottom-small u-margin-top-small">
        <h2 class="heading-2">Web Projects</h2>
    </div>

    <div class="web_projects__container">

        <figure class="web_projects__container__item">
            <a title="ClioTravel LTD website"
                ...
                <figcaption class="web_projects__container__item__caption"> 
                    <h3>ClioTravel</h3>
                    <br>
                    <p>Build the website for local travel agency</p>
                    <p class="u-margin-top-small"><strong>Tags:</strong> <br />Design, Development, PHP, JS, HTML, CSS</p>
                </figcaption>
            </a>
        </figure>
        <figure class="web_projects__container__item">
            <a title="Predistic LTD IOT website"
                ...
                <figcaption class="web_projects__container__item__caption">
                    <h3>Iot Predistic</h3>
                    <br>
                    <p>Build the website for Predistic LTD</p>
                    <p class="u-margin-top-small"><strong>Tags:</strong> <br />Development, ReactJS, JS, HTML, CSS</p>
                </figcaption>
            </a>
        </figure>
    </div>
